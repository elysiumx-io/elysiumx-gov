import{Y as w}from"./chunk-37ISZE7G-YL9du2Vf.js";import{j as E}from"./loginAccount-26B5XW5Y-CLlrwZgu.js";import{C as _}from"./chunk-PHADJY2T-BaOF7PIT.js";import{cc as k,r as l,cd as N,ce as B,cf as b,cg as $,aw as z,Y as T,$ as j,ax as F,an as Y,a4 as e,a5 as A,ch as C,ao as M,b5 as U}from"./index-BNM2Gi5R.js";import{u as D}from"./index-BbMz4L5z.js";import"./chunk-YNAB6HVU-Cz67zcwW.js";import"./chunk-TT34D6R6-rAh4iaYe.js";import"./throttle-CU5bTBsH.js";function I(s,n){var t,a=k(s),u=(t=n?.wait)!==null&&t!==void 0?t:1e3,r=l.useMemo(function(){return N(function(){for(var o=[],c=0;c<arguments.length;c++)o[c]=arguments[c];return a.current.apply(a,B([],b(o),!1))},u,n)},[]);return $(function(){r.cancel()}),{run:r,cancel:r.cancel,flush:r.flush}}function L(s,n,t){var a=b(l.useState({}),2),u=a[0],r=a[1],o=I(function(){r({})},t).run;l.useEffect(function(){return o()},n),D(s,[u])}var R=`.account-bind-container {
  display: flex;
