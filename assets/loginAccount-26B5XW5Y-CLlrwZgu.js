import{C as _}from"./chunk-PHADJY2T-BaOF7PIT.js";import{d as w}from"./chunk-YNAB6HVU-Cz67zcwW.js";import{p as k}from"./chunk-TT34D6R6-rAh4iaYe.js";import{cc as E,r as h,ce as N,cf as $,cg as O,$ as T,aw as j,Y as A,an as S,a4 as l,a5 as z,ar as C,aa as B,a0 as s,a9 as I,ak as M,al as P,ai as F}from"./index-BNM2Gi5R.js";import{N as L}from"./throttle-CU5bTBsH.js";function R(c,e){var o,r=E(c),u=(o=e?.wait)!==null&&o!==void 0?o:1e3,t=h.useMemo(function(){return L(function(){for(var i=[],n=0;n<arguments.length;n++)i[n]=arguments[n];return r.current.apply(r,N([],$(i),!1))},u,e)},[]);return O(function(){t.cancel()}),{run:t,cancel:t.cancel,flush:t.flush}}var U=`.login-account-box {
  display: flex;
