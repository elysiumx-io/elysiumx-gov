import type { DAOProposalData, User } from '../types';
import React, { useEffect, useState } from 'react';
import { pollApi, userApi } from '../utils/api';
...
const CreatePollModal: React.FC<CreatePollModalProps> = ({ isOpen, onClose, onPollCreated }) => {
  ...
  return (
    <div className="fixed inset-0 backdrop-filter backdrop-blur-md flex items-center justify-center z-50 no-scrollbar">
      <div className="bg-gray-950 rounded-2xl shadow-xl max-w-[700px] w-full mx-4 max-h-[90vh] overflow-y-auto no-scrollbar ">
        <div className="p-6">
          {/* Header */}
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <DAOProposalEditor
              ...
              mode="new"
              onChange={(data: DAOProposalData) => setFormData({ ...formData, description: JSON.stringify(data, null, 2) })}
            />
